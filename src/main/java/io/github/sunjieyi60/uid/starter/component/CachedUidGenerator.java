 ...
 */
package io.github.sunjieyi60.uid.starter.component;

import io.github.sunjieyi60.uid.starter.utils.BitsAllocator;
import io.github.sunjieyi60.uid.starter.UidGenerator;
import io.github.sunjieyi60.uid.starter.buffer.BufferPaddingExecutor;
import io.github.sunjieyi60.uid.starter.buffer.RejectedPutBufferHandler;
import io.github.sunjieyi60.uid.starter.buffer.RejectedTakeBufferHandler;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.initRingBuffer();
        LOGGER.info("RingBuffer loading completed");
    }
    ...
    private void initRingBuffer() {
        ...
        LOGGER.info("BufferPaddingExecutor Using schdule:{}, interval:{}", usingSchedule, scheduleInterval);
